...
if __name__ == "__main__":
    ...
    print("\nMain Endpoints:")
    print("  - POST http://localhost:8112/calculate")
    print("  - GET  http://localhost:8112/products?query=stainless+steel+tumbler")
    print("  - GET  http://localhost:8112/outlets?query=SS+2+opening+time")
    print("  - GET  http://localhost:8112/health")
    print("  - GET  http://localhost:8112/docs")
    print("\nTest Endpoints:")
